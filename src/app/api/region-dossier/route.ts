...
/**
 * Infowitz MENA — Region Dossier API
  ...
  try {
    ...
    const [countryResult, wikiResult, hosResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[Infowitz] Country fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[Infowitz] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[Infowitz] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
