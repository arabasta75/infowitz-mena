...
const MISSION_CLASSIFY: Record<string, { mission: string; color: string }> = {
  'USA': { mission: 'Military Recon', color: '#EF4444' },
  'NROL': { mission: 'NRO Classified', color: '#EF4444' },
  'LACROSSE': { mission: 'SAR Imaging', color: '#38BDF8' },
  'MENTOR': { mission: 'SIGINT', color: '#FFFFFF' },
  'ORION': { mission: 'SIGINT', color: '#FFFFFF' },
  'TRUMPET': { mission: 'SIGINT', color: '#FFFFFF' },
  'GPS': { mission: 'Navigation', color: '#2563EB' },
  'NAVSTAR': { mission: 'Navigation', color: '#2563EB' },
  'GLONASS': { mission: 'Navigation', color: '#2563EB' },
  'GALILEO': { mission: 'Navigation', color: '#2563EB' },
  'BEIDOU': { mission: 'Navigation', color: '#2563EB' },
  'SBIRS': { mission: 'Early Warning', color: '#FF00FF' },
  'DSP': { mission: 'Early Warning', color: '#FF00FF' },
  'STARLINK': { mission: 'Commercial Comms', color: '#10B981' },
  'ONEWEB': { mission: 'Commercial Comms', color: '#10B981' },
  'PLANET': { mission: 'Earth Imaging', color: '#10B981' },
  'WORLDVIEW': { mission: 'Commercial Imaging', color: '#10B981' },
