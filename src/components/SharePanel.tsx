        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex gap-2">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('🏛️ Infowitz MENA — Global Intelligence Dashboard')}&url=${encodeURIComponent(generateShareUrl())}`}
                target="_blank"
              ...
              <a
                href={`https://reddit.com/submit?url=${encodeURIComponent(generateShareUrl())}&title=${encodeURIComponent('Infowitz MENA — Open Source Global Intelligence Platform')}`}
                target="_blank"
                className="flex-1 text-center py-1.5 rounded text-[7px] font-mono tracking-wider text-[var(--text-muted)] border border-[var(--border-primary)] hover:border-[#2563EB] hover:text-[#2563EB] transition-colors"
              >
                REDDIT
              </a>
            </div>
